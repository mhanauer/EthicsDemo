...
```
Work setting here.  Not counting any k-12 that also includes private practice.  This is a pure k-12 indicator
```{r}
...
WorkSettingDat1 = apply(WorkSettingDat1, 2, function(x){ifelse(x == "Preschool", "Preschool", ifelse(x == "K-12 School System", "K-12 School System", ifelse(x == "Elementary School", "Elementary School", ifelse(x == "Junior High/Middle School", "Junior High/Middle School", ifelse(x == "High School", "High School", ifelse(x == "Special Education Cooperative", "Special Education Cooperative", ifelse(x == "Community Mental Health Center", "Community Mental Health Center", ifelse(x == "Hospital or Clinic", "Hospital or Clinic", ifelse(x == "Private Practice", "Private Practice", ifelse(x == "College or University", "College or University", ifelse(x == "Other", "Other", "Multiple work settings")))))))))))})
...
TrainingCount
write.csv(TrainingCount, "TrainingCount.csv", row.names = FALSE)
```
...
write.xlsx(WorkSettingCount, file="EthicsAnswered.xlsx", sheetName="WorkSettingCount", append=TRUE, row.names=FALSE)
write.xlsx(YearsExperCount, file="EthicsAnswered.xlsx", sheetName="YearsExperCount", append=TRUE, row.names=FALSE)
write.xlsx(GenderCount, file="EthicsAnswered.xlsx", sheetName="GenderCount", append=TRUE, row.names=FALSE)
write.xlsx(AgeCount, file="EthicsAnswered.xlsx", sheetName="AgeCount", append=TRUE, row.names=FALSE)
write.xlsx(EthCount, file="EthicsAnswered.xlsx", sheetName="EthCount", append=TRUE, row.names=FALSE)
write.xlsx(EthDilemCount, file="EthicsAnswered.xlsx", sheetName="EthDilemCount", append=TRUE, row.names=FALSE)
write.xlsx(TrainingCount, file="EthicsAnswered.xlsx", sheetName="TrainingCount", append=TRUE, row.names=FALSE)
```
